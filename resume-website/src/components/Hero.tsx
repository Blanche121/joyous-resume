        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              >
                <span className="text-sm font-medium text-slate-700">数据科学</span>
              </motion.div>
              <motion.div
                animate={{ y: [0, 10, 0] }}
              ...
              >
                <span className="text-sm font-medium text-slate-700">游戏洞察</span>
              </motion.div>
              <motion.div
                animate={{ y: [0, 10, 0] }}
              ...
              >
                <span className="text-sm font-medium text-slate-700">数据分析</span>
              </motion.div>
              <motion.div
                animate={{ y: [0, -10, 0] }}
